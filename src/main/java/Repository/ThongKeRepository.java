...
public class ThongKeRepository {
    ...
    public List<Map<String, Object>> getKhachHangNhieuDichVuNhat(java.util.Date fromDate, java.util.Date toDate, int limit) {
        ...
        String sql = "SELECT TOP ? " +
                    ...
                    "kh.SoDienThoai, " +
                    "kh.LoaiKhach, " +
                    "COUNT(ct.MaDichVu) as SoDichVuDaDung, " + // Access không hỗ trợ COUNT(DISTINCT)
    ...
    public List<Map<String, Object>> getDoanhThuTheoNgay(java.util.Date fromDate, java.util.Date toDate) {
        ...
        String sql = "SELECT " +
                    "hd.NgayLap as Ngay, " + // Access không có DATE type riêng, dùng DateTime
                    "SUM(hd.TongTien) as DoanhThu, " +
                    "COUNT(hd.MaHoaDon) as SoHoaDon " +
                    "FROM HoaDon hd " +
                    "WHERE hd.NgayLap BETWEEN ? AND ? " +
                    "GROUP BY hd.NgayLap " + // Group theo DateTime
                    "ORDER BY Ngay";
