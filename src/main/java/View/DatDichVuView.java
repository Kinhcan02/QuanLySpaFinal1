...
public class DatDichVuView extends JPanel {
    ...
    // Getter methods
    public JComboBox<String> getCboKhachHang() { return cboKhachHang; }
    public JComboBox<String> getCboDichVu() { return cboDichVu; }
    ...
    public JLabel getLblDiemTichLuy() { return lblDiemTichLuy; }
    public JLabel getLblTongTien() { return lblTongTien; }
    public JTable getTblDichVuDaChon() { return tblDichVuDaChon; }
    public DefaultTableModel getTableModel() { return tableModel; }
    public JButton getBtnThemKhachHang() { return btnThemKhachHang; }
    public JButton getBtnThemDichVu() { return btnThemDichVu; }
    public JButton getBtnXoaDichVu() { return btnXoaDichVu; }
    public JButton getBtnDoiDiem() { return btnDoiDiem; }
